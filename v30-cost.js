...
document.querySelector('#recalcBtn').onclick=()=>{if(!dataset.length){toast('请先输入 SP / PV / MV 历史 CSV');return}analyze(dataset);const type=document.querySelector('#loopType').selectedOptions[0].text;toast(`V30 已按 ${type} 与当前权重重新评估`)};
